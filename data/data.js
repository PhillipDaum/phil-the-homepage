// PROJECTS! - easy to add or subtract, the grid likes things in threes 
let projects = [
    {
        title: "Cannon's Coffee",
        image: "./img/portfolio-coffee.png",
        imageAlt: "Screenshot of a beautiful coffeeshop website with blue, yellow, green and white.",
    ...
    },
    {
        ...
        imageAlt: "Screenshot of a whimsical and accessible icecream order form",
    ...
    },
    {
        ...
        imageAlt: "Screenshot of a site that says 'when and where is it sunny?' with a form for continent and month, below is a list of cities organized by average monthly sunshine hours.",
        description: "After learning loops, I returned to this previously unfinished project and breathed life into it! Use this to find cities where it is likely to be sunny.",
        gitHub: "https://github.com/PhillipDaum/city-picker",
        gitHubPages: "https://phillipdaum.github.io/city-picker/",
    },
    {
        title: "PhilDaum.art",
        image: "./img/portfolio-art.png",
        imageAlt: "Screenshot of a tidy art portfolio site, in frame is a loud and colorful abstract painting.",
        description: "I built a new art portfolio site for myself after completing a 6-week course on Bootstrap in 2022.",
        gitHub: "https://github.com/PhillipDaum/phildaum.art",
        gitHubPages: "https://www.phildaum.art/",
    },
    {
